...
var file_spacemesh_v1_debug_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa0, 0x02, 0x0a, 0x0c, 0x44, 0x65, 0x62, 0x75, 0x67, 0x53,
	...
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x30, 0x01, 0x12, 0x3d, 0x0a, 0x0d, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x14, 0x2e, 0x73, 0x70, 0x61, 0x63, 0x65, 0x6d, 0x65, 0x73, 0x68, 0x2e, 0x76,
	0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68,
...
var file_spacemesh_v1_debug_proto_goTypes = []interface{}{
	...
	(*Config)(nil),              // 4: spacemesh.v1.Config
}
var file_spacemesh_v1_debug_proto_depIdxs = []int32{
	...
	0, // 3: spacemesh.v1.DebugService.Configuration:input_type -> google.protobuf.Empty
	1, // 4: spacemesh.v1.DebugService.NetworkInfo:output_type -> spacemesh.v1.NetworkInfoResponse
	2, // 5: spacemesh.v1.DebugService.Accounts:output_type -> spacemesh.v1.AccountsResponse
	3, // 6: spacemesh.v1.DebugService.ProposalsStream:output_type -> spacemesh.v1.Proposal
	4, // 7: spacemesh.v1.DebugService.Configuration:output_type -> spacemesh.v1.Config
...
type DebugServiceClient interface {
	...
	Configuration(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Config, error)
}
...
func (c *debugServiceClient) Configuration(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Config, error) {
	out := new(Config)
	err := c.cc.Invoke(ctx, "/spacemesh.v1.DebugService/Configuration", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DebugServiceServer interface {
	...
	// Configuration of the node.
	Configuration(context.Context, *empty.Empty) (*Config, error)
}
...
func (*UnimplementedDebugServiceServer) Configuration(context.Context, *empty.Empty) (*Config, error) {
...
func _DebugService_Configuration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DebugServiceServer).Configuration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spacemesh.v1.DebugService/Configuration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DebugServiceServer).Configuration(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DebugService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DebugService_Configuration_Handler,
		},
	},
