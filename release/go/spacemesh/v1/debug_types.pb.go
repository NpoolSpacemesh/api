...
type Config struct {
	...
	EpochSize uint32 `protobuf:"varint,1,opt,name=epochSize,proto3" json:"epochSize,omitempty"`
}
...
func (x *Config) GetEpochSize() uint32 {
	if x != nil {
		return x.EpochSize
	}
	return 0
...
var file_spacemesh_v1_debug_types_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x22, 0x26, 0x0a, 0x06,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x53,
	0x69, 0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x65, 0x70, 0x6f, 0x63, 0x68,
	0x53, 0x69, 0x7a, 0x65, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_spacemesh_v1_debug_types_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_spacemesh_v1_debug_types_proto_goTypes = []interface{}{
	...
	(*Config)(nil),              // 6: spacemesh.v1.Config
	(*Account)(nil),             // 7: spacemesh.v1.Account
	(*SimpleInt)(nil),           // 8: spacemesh.v1.SimpleInt
	(*LayerNumber)(nil),         // 9: spacemesh.v1.LayerNumber
	(*SmesherId)(nil),           // 10: spacemesh.v1.SmesherId
}
var file_spacemesh_v1_debug_types_proto_depIdxs = []int32{
	7,  // 0: spacemesh.v1.AccountsResponse.account_wrapper:type_name -> spacemesh.v1.Account
	8,  // 1: spacemesh.v1.Proposal.epoch:type_name -> spacemesh.v1.SimpleInt
	9,  // 2: spacemesh.v1.Proposal.layer:type_name -> spacemesh.v1.LayerNumber
	10, // 3: spacemesh.v1.Proposal.smesher:type_name -> spacemesh.v1.SmesherId
